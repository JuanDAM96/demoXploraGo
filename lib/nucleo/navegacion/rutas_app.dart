...
import 'package:xplorago/vistas/pantallas/pantalla_gasto.dart';
...
import 'package:xplorago/vistas/pantallas/pantalla_actividades.dart';
...
class RutasApp {
  ...
  static Map<String, WidgetBuilder> get rutas => <String, WidgetBuilder>{
    ...
    actividades: (_) => const PantallaActividades(),
  gastos: (_) => const PantallaGasto(),
