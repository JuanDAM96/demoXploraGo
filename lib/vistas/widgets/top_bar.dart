...
class TopBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color resolvedMenuBackgroundColor =
        menuBackgroundColor ?? Theme.of(context).colorScheme.primary;
    final Color resolvedMenuTextColor =
        menuTextColor ?? Theme.of(context).colorScheme.onPrimary;
                    ...
                    leading ??
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Image.asset(
                              'assets/imagenes/logo_XploraGo.png',
                              fit: BoxFit.contain,
    ...
    if (menuItems.isNotEmpty) {
      return PopupMenuButton<int>(
        ...
        itemBuilder: (BuildContext context) {
          return List<PopupMenuEntry<int>>.generate(menuItems.length, (
            int index,
          ) {
